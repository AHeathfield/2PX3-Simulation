...
class Intersection:
    ...
    #     # Right Lane Turn intos interfearing with connectors
    #     self.sim.define_interfearing_paths([16, 15], [15, 20], turn=True)
    #     # self.sim.define_interfearing_paths([16, 19], [15, 16], turn=True)
    #     # Left Turn intos interfearing with right lane connectors
    #     self.sim.define_interfearing_paths([40, 19], [39, 16], turn=True)
